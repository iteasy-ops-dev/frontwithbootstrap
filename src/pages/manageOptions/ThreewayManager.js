...
const SetupFields = ({ formData, onChange }) => {
  ...
  //  const checkDomains = (domains) => {
  //    return replaceWord(domains, ',', ' ')
  //  }
  //
  //  const handleDomains = (e) => {
  //    console.log(e)
  //    e.target.value = checkDomains(e.target.value)
  //    onChange(e)
  //  }
  ...
  return (
    <>
      <Row className="mb-3">
        ...
        <Col>
          <InputGroup className="mb-3" data-bs-theme={`${theme}`}>
            <InputGroup.Text>cband(GB)</InputGroup.Text>
            <Form.Control
              type="text"
              name="cband_limit"
              value={formData.cband_limit || ""}
              onChange={onChange}
              placeholder="GB단위로 숫자만 넣으세요."
            />
          </InputGroup>
        </Col>
      </Row>
      <Row className='mb-3'>
        <Col>
          <InputGroup className="mb-3" data-bs-theme={`${theme}`}>
            <InputGroup.Text>생성할 도메인</InputGroup.Text>
            <Form.Control
              type="text"
              name="domains"
              ...
              onChange={onChange}
              placeholder="생성할 도메인 전부를 입력하세요. ex) domain1.com domain2.com"
            />
          </InputGroup>
        </Col>
      </Row>
