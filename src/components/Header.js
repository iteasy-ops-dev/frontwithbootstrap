...
//             <Dropdown.Divider />
//             <Dropdown.Item onClick={handleExpirationExtension}><i class="bi bi-plus-circle"></i> Expiration extension</Dropdown.Item>
...
//         <Dropdown align="end">
//           <Dropdown.Toggle variant={`outline-${theme === "dark" ? "light" : "dark"}`} id="dropdown-basic">
//             {getUserToken().email} - {timeLeft}
//           </Dropdown.Toggle>

//           <Dropdown.Menu>
//             <Dropdown.Item onClick={handleProfile}><i className="bi bi-person-circle"></i> Profile</Dropdown.Item>
//             <Dropdown.Divider />
//             <Dropdown.Item onClick={handleExpirationExtension}><i className="bi bi-plus-circle"></i> Expiration extension</Dropdown.Item>
